...
// Trigger-flavored CRDs from the eventing/CI ecosystems the Nexus demo showcases
// (Knative eventing, Tekton triggers, Argo Events). Tracked as a separate set so
// the "allow all triggers" allow-list can be audited independently from the core
// kinds above.
