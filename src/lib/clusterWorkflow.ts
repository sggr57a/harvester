...
// showcases: Knative eventing (Trigger), Tekton triggers (TriggerTemplate,
// TriggerBinding, ClusterTriggerBinding, EventListener) and Argo Events
// (EventSource, Sensor). Tracked as a separate set so the "allow all
// triggers" allow-list can be audited independently from the core kinds
// above.
